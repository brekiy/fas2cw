...
if CLIENT then
    ...
    att.description = {
        [1] = {t = "Caliber conversion to .357 Magnum.", c = CustomizableWeaponry.textColors.NEUTRAL},
        [2] = {t = "Increases mag size to 9 rounds.", c = CustomizableWeaponry.textColors.POSITIVE}
    }
end
