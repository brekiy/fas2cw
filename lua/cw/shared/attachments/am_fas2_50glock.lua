...
if CLIENT then
    ...
    att.description = {
        [1] = {t = "Caliber conversion to .50 GI.", c = CustomizableWeaponry.textColors.NEUTRAL},
        [2] = {t = "Decreases mag size to 9 rounds.", c = CustomizableWeaponry.textColors.NEGATIVE}
    }
end
